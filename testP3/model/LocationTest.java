...
public class LocationTest {
  ...
  private model.Location location2;
  ...
  @Before
  public void setUp() {
    location = new model.Location(3,3);
    location2 = new model.Location(0,0);
  }

  private model.Location loc(int x, int y) {
    return new model.Location(x,y);
  }
  ...
  public void distanceTest() {
    ...
    model.Location location3 = loc(5,3);
  ...
  public void equalsTest() {
    ...
    model.Location location3 = loc(0,0);
    ...
    model.Location location4 = loc(3,3);
