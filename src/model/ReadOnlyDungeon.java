...
public class ReadOnlyDungeon {
  private final model.Dungeon d;
  private final model.Player p;
   ...
   */
  ReadOnlyDungeon(Dungeon d, model.Player p) {
    this.d = d;
    this.p = p;
  }
   ...
   */
  public model.Location getPlayerLoc() {
   ...
   */
  public List<model.Location> getVisits() {
