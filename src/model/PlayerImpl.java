 ...
 */
class PlayerImpl implements model.Player {
   ...
   */
  public PlayerImpl(String name, model.Cave cave) throws IllegalArgumentException {
  ...
  @Override
  public void updateLocation(model.Cave cave) throws IllegalArgumentException {
    if (cave == null) {
      throw new IllegalArgumentException(
              "Cave can't be null");
    }
    ...
    boolean isLoc = false;
    for (model.Location loc: this.cave.getDirections().values()) {
