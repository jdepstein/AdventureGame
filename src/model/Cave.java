...
public interface Cave {
   ...
   */
  void addConnection(model.enums.Direction dir, Location loc) throws IllegalArgumentException;
   ...
   */
  boolean addTreasure(model.enums.CaveObject caveObject) throws IllegalArgumentException;
   ...
   */
  Map<model.enums.CaveObject, Integer> removeItems();
   ...
   */
  void updateSmell(model.enums.Smell smell);
