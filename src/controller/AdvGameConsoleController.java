...
public class AdvGameConsoleController implements AdvGameController {
  ...
  private final Map<String, Function<Scanner, controller.AdventureCommand>> knownCommands;
  ...
  public void playGame(Dungeon d) {
    ...
    while (!d.hasLost() && !quitting) {
      ...
      while (!execute) {
        ...
        String in = scan.next();
        Function<Scanner, controller.AdventureCommand> cmd1 = this.knownCommands.getOrDefault(in, null);
