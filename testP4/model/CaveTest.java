...
public class CaveTest {
  ...
  @Before
  public void setUp() {
    this.myCave = new model.CaveImpl(new model.Location(0, 0));
  }

  private model.Cave cave(model.Location loc) {
  ...
  public void badConnection1() {
    myCave.addConnection(null, new model.Location(2, 2));
  }
  ...
  public void badConnection3() {
    myCave.addConnection(Direction.NORTH, new model.Location(0, 0));
  }
  ...
  public void overrideConnection() {
    myCave.addConnection(Direction.NORTH, new model.Location(1, 1));
    myCave.addConnection(Direction.NORTH, new model.Location(1, 2));
  }
  ...
  public void overrideConnection2() {
    myCave.addConnection(Direction.NORTH, new model.Location(1, 1));
    myCave.addConnection(Direction.EAST, new model.Location(1, 1));
  }
  ...
  public void removeItemsTest() {
    ...
    myCave.addConnection(Direction.NORTH, new model.Location(0 ,  1));
  ...
  public void newMethods() {
    ...
    myCave.addMonster(new model.Otyugh());
  ...
  public void monsterAdding() {
    this.myCave.addMonster(new model.Otyugh());
    assertFalse(this.myCave.addMonster(new model.Otyugh()));

    Cave cave1 = cave(new model.Location(0, 0));
    cave1.addConnection(Direction.NORTH, new model.Location(1, 0));
    cave1.addConnection(Direction.SOUTH, new model.Location(2, 0));
